...
WEBSITE_POLLING_URL = 'http://iotwist.com:8200/api/drone/bookings/{}'.format(HIKEY_IP_ADDRESS, CLIENT_ETHEREUM_ADDRESS)
WEBSITE_STATUS_URL =  'http://iotwist.com:8200/api/drone/status/{}'.format(HIKEY_IP_ADDRESS, CLIENT_ETHEREUM_ADDRESS)
